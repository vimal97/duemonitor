...
<body data-ng-app="" class="ng-scope">
            ...
            <nav class="navigation">
            	<ul class="list-unstyled">
                    ...
                    <li class="has-submenu"><a href="f_dues.php"><i class="fa fa-flag-o"></i> <span class="nav-label">add dues</span></a>
					 ...
					 <li class="has-submenu"><a href="f_cal.php"><i class="fa fa-flag-o"></i> <span class="nav-label">CALENDER</span></a>
                    	
                    </li>
					<li class="active"><a href="#"><i class="fa fa-heart-o"></i> <span class="nav-label">Contact admin</span></a>
  ...
  <form action="/action_page.php">
    ...
    <div class="row">
      ...
      <div class="col-75">
        <p style="text-align:center"><input type="text" id="lname" name="lastname" placeholder="Feedback on idea.."></p>
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-75">
        <p style="text-align:center"><textarea id="subject" name="subject" placeholder="If any problems faced , please explain..." style="height:200px"></textarea></p>
      </div>
    </div>
    <div class="row">
	</br>
