...
<body data-ng-app="" class="ng-scope">
  ...
  <img src="img_avatar2.jpeg" alt="" style="width:100%;">
  <div style="background-color:white;">
  </br>
  </br>
  <h1> <?php echo "$name"; ?></h1>
  <p class="title">Department :: <?php echo "$dept"; ?></p>
  <p class="title">Faculty Id :: <?php echo "$facid"; ?></p>
  <p class="title">Due Field :: <?php echo "$field"; ?></p>
  <p class="title">Designation :: <?php echo "$designation"; ?></p>
 ...
 <p><a href="fac_logout.php"><button>LOGOUT</button></a></p>
</div>
	   </br></br></br></br>
     </div>   
